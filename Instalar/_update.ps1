...
#Aún en proceso de desarrollo para la versión de español latino
...
$ingame_name = "SpanishLatin (Español(Latinoamérica))"
...
function UpdateContent {
    <#
        ...
        .EXAMPLE
        UpdateContent -LocalRepo "Ludeon-RimWorld-SpanishLatin" -Name "Core"
