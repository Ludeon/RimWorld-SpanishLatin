...
# Descomentar esta línea y comentar la anterior para saltarse las carpetas "* - Castellano"
$roots = Get-ChildItem -Directory | Where-Object { $_.Name -notlike "* - Castellano" } | ForEach-Object { $_.Name }
