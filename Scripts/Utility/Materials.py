...
def add_materials(text):
    ...
    if choice == "1":
        materials = wood + steel + silver + uranium + plasteel + gold + bioferrite + obsidian
    elif choice == "2":
        materials = wood + steel + sandstone + granite + limestone + slate + marble + jade + silver + uranium + plasteel + gold + obsidian + bioferrite + voidstone
    elif choice == "3":
        materials = (
            cloth + light_leather + sheep_wool + smooth_leather + devilstrand + synthetic_fabric +
            megasloth_wool + muffalo_wool + bison_wool + mastodon_wool + muskox_wool + alpaca_wool +
            bird_skin + hyperweave + patch_leather + dog_leather + lizard_leather + wolf_skin + feline_fur +
            fox_fur + pig_skin + camel_leather + bear_skin + blue_fur + elephant_leather + mastodon_leather +
            thick_fur + scary_leather + seal_skin + rhino_leather + guinea_pig_fur + chinchilla_fur + 
            armadillo_leather + hippo_leather + mink_skin + human_leather + trumbo_fur + trumbo_mane
        )
    elif choice == "4":
        materials = (
            cloth + sheep_wool + devilstrand + synthetic_fabric +
            megasloth_wool + muffalo_wool + bison_wool + mastodon_wool +
            muskox_wool + alpaca_wool + hyperweave
        )
    else:
