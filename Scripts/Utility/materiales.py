...
def agregar_materiales(texto):
    ...
    print("2. Madera', 'Acero', 'Arenisca', 'Granito', 'Caliza', 'Pizarra', 'Mármol', 'Jade', 'Plata', 'Uranio', 'Plastiacero', 'Oro', 'Bioferrita', 'Obsidiana', 'Vaciorita")
    print("3. Textiles")
    ...
    if opcion == "1":
        ...
        for material in lista_madera + lista_acero + lista_plata + lista_uranio + lista_plastiacero + lista_oro + lista_bioferrita + lista_obsidiana:
            print(material)
    elif opcion == "2":
        print("\nContenido de la lista 2:")
        for material in lista_madera + lista_acero + lista_arenisca + lista_granito + lista_caliza + lista_pizarra + lista_marmol + lista_jade + lista_plata + lista_uranio + lista_plastiacero + lista_oro + lista_obsidiana + lista_bioferrita + lista_vaciorita:
            print(material)
    elif opcion == "3":
        print("\nContenido de la lista 3:")
        for material in lista_tela + lista_cuero_ligero + lista_lana_de_oveja + lista_cuero_liso + lista_hilodiablo + lista_tela_sintetica + lista_lana_de_megaperezoso + lista_lana_de_mufalo + lista_lana_de_bisonte + lista_lana_de_mastodonte + lista_lana_de_buey_almizclero + lista_lana_de_alpaca + lista_piel_de_pajaro + lista_hipertejido + lista_cuero_parcheado + lista_cuero_de_perro + lista_cuero_de_lagarto + lista_piel_de_lobo + lista_pelaje_felino + lista_pelaje_de_zorro + lista_piel_de_cerdo + lista_cuero_de_camello + lista_piel_de_oso + lista_pelaje_azul + lista_cuero_de_elefante + lista_cuero_de_mastodonte + lista_pelaje_grueso + lista_cuero_temible + lista_piel_de_pinnipeda + lista_cuero_de_rinoceronte + lista_pelaje_de_cuy + lista_pelaje_de_chinchilla + lista_cuero_de_armadillo + lista_cuero_de_hipopotamos + lista_piel_de_vison + lista_cuero_humano + lista_pelaje_de_trumbo + lista_crin_de_trumbo:
            print(material)
    elif opcion == "4":
        print("\nContenido de la lista 4:")
        for material in lista_tela + lista_lana_de_oveja + lista_hilodiablo + lista_tela_sintetica + lista_lana_de_megaperezoso + lista_lana_de_mufalo + lista_lana_de_bisonte + lista_lana_de_mastodonte + lista_lana_de_buey_almizclero + lista_lana_de_alpaca + lista_hipertejido:
            print(material)
    else:
